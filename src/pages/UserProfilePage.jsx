        ...
        return (
            <div className={`profile-page-container ${darkMode ? 'dark' : ''}`}>
                <div className="profile-not-authenticated">
                    ...
                    <p>Будь ласка, <Link to="/logIn" className="profile-login-link">увійдіть</Link>, щоб переглянути свої дані профілю.</p>
                </div>
            </div>
        );
    }
                ...
                <div className="profile-sidebar">
                    ...
                    <div className={`profile-actions-section ${darkMode ? 'dark' : ''}`}>
                        ...
                        <div className="action-buttons">
                            ...
                            <Link to="/booking" className="action-btn secondary">
                                Мої бронювання
                            </Link>
                        </div>
                    </div>
                    ...
                    <div className={`profile-info-section ${darkMode ? 'dark' : ''}`}>
                        ...
                        <div className="info-content">
                            <p>Тут ви можете переглянути всю інформацію про свій профіль, відгуки та бронювання.</p>
